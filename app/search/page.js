  ...
  return (
    <div className={styles.container}>
      <form className={styles.form} onSubmit={onSubmitHandler}>
        ...
        <input type="text" placeholder="test" value={input} name="pitcherName" onChange={onChangeHandler} className={styles.input} required/>
        <label htmlFor="endDate" className={styles.label}>End Date:</label>
        <input type="text" placeholder="test2" value={input} name="pitcherName" onChange={onChangeHandler} className={styles.input} required/>
