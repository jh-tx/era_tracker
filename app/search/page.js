  ...
  return (
    <div className={styles.container}>
      <form className={styles.form} onSubmit={onSubmitHandler}>
        ...
        <input type="date" value={startDate} id="startDate" className={styles.input} name="startDate" min="1900-01-01" onChange={onStartDateChangeHandler} max="2024-12-31" required/>
        <label htmlFor="endDate" className={styles.label}>End Date:</label>
        <input type="date" value={endDate} id="endDate"  className={styles.input} name="endDate" min="1900-01-01" onChange={onEndDateChangeHandler} max="2024-12-31" required/>
